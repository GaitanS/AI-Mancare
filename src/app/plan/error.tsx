  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-2xl font-bold text-neutral-900 mb-2">Nu am putut incarca planul</h1>
        <p className="text-neutral-500 mb-6">A aparut o problema la incarcarea planului saptamanal. Va rugam incercati din nou.</p>
