...
import { cn, formatPrice, truncate, normalizeDifficulty } from '@/lib/utils';
...
export default function RecipeCard({
  ...
  const difficulty = difficultyConfig[normalizeDifficulty(recipe.difficulty) as keyof typeof difficultyConfig] || difficultyConfig.MEDIU;
        ...
        <div className="flex flex-col flex-1 p-4">
          ...
          <div className="mt-auto pt-3 border-t border-neutral-100">
            <div className="flex items-center justify-between text-sm">
              ...
              {/* Calories */}
              {recipe.calories && recipe.servings && recipe.servings > 0 && (
